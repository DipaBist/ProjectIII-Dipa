...
<body>
    ...
    <aside class="sidebar">
        <ul class="sidebar-menu">
            <li><a href="dashboard.php" class="sidebar-link"><i class="fas fa-chart-line"></i> Dashboard</a></li>
            ...
            <li><a href="../orders/add_orders.php" class="sidebar-link"><i class="fas fa-shopping-cart"></i> Orders</a></li>
